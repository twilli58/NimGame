...
public class Gui {
	...
	private void buildComputerPlayerMenu() {
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Gui.this.theGame.computerPlayer().setStrategy(new CautiousStrategy());
			}
		});		
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Gui.this.theGame.computerPlayer().setStrategy(new GreedyStrategy());
			}
		});		
		computerPlayerMenu.add(menuItem);
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Gui.this.theGame.computerPlayer().setStrategy(new RandomStrategy());
			}
		});		
		computerPlayerMenu.add(menuItem);
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Gui.this.theGame.computerPlayer().setStrategy(new ExpertStrategy());
			}
		});		
		computerPlayerMenu.add(menuItem);
	...
	private void buildFileMenu() {
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Gui.this.theNewGamePanel.setEnabled(true);
				Gui.this.theHumanPlayerPanel.setEnabled(false);
				Gui.this.theComputerPlayerPanel.resetNumberTaken();
				Gui.this.theHumanPlayerPanel.resetNumberToTakeComboBox(Game.MAX_STICKS_PER_TURN);
				if (Gui.this.shouldShowHelpDialog) {
					Gui.this.shouldShowHelpDialog = Gui.this.showHelpDialog();
				}
			}
		});		
	...
	private final class NewGamePanel extends JPanel {
		...
		private void addPlayerButtons() {
			...
			this.buttons.add(this.humanPlayerButton);
			this.buttons.add(this.computerPlayerButton);
			this.buttons.add(this.randomPlayerButton);			
		...
		private class ComputerFirstListener implements ActionListener {
			...
			public void actionPerformed(ActionEvent event) {
				...
				Gui.this.theComputerPlayerPanel.setEnabled(true);
				Gui.this.theHumanPlayerPanel.setEnabled(true);
				setEnabled(false);
				Gui.this.theGame.startNewGame(theComputer, theHuman, 
						(int)pileSizeComboBox.getSelectedItem());
				theComputer.setPileForThisTurn(Gui.this.theGame.pile());
		...
		private class HumanFirstListener implements ActionListener {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				Gui.this.theComputerPlayerPanel.setEnabled(true);
				setEnabled(false);
				Gui.this.theGame.startNewGame(theHuman, theComputer, 
						(int)pileSizeComboBox.getSelectedItem());
			}
		}
		...
		private class PileSizeListener implements ActionListener {
			...
			@Override
			public void actionPerformed(ActionEvent event) {
				Gui.this.theGame.setPileSize((int)pileSizeComboBox.getSelectedItem());
