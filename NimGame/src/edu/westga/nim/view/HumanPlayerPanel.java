	...
	private class TakeTurnListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			if (!HumanPlayerPanel.this.theGame.isGameOver()) {
				HumanPlayerPanel.this.theHuman.setPileForThisTurn(HumanPlayerPanel.this.theGame.pile());
				HumanPlayerPanel.this.theHuman.setNumberSticksToTake(
								(int) HumanPlayerPanel.this.numberToTakeComboBox.getSelectedItem());
				HumanPlayerPanel.this.theGame.play();
			}
			
			if (!HumanPlayerPanel.this.theGame.isGameOver()) {
				HumanPlayerPanel.this.theComputer.setPileForThisTurn(HumanPlayerPanel.this.theGame.pile());
				HumanPlayerPanel.this.theComputer.setNumberSticksToTake();
				HumanPlayerPanel.this.theGame.play();				
			}
		}
